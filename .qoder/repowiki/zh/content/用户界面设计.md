...
这是一个基于Web Speech API的语音识别应用，采用科幻暗色主题设计。该应用提供了实时语音转文字的功能，具有丰富的用户界面交互效果，包括粒子背景动画、声波动画、状态指示器等现代化UI元素。
...
**图表来源**
- [app.js:125-155](file://js/app.js#L125-L155)
...
**章节来源**
- [app.js:122-155](file://js/app.js#L122-L155)
