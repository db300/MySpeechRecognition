...
这是一个基于Web Speech API的语音识别应用，提供了麦克风按钮无响应、录音状态指示异常、文本显示错乱等UI相关问题的故障排除指南。该应用支持两种识别后端：浏览器原生Web Speech API和讯飞语音识别服务，并包含Canvas粒子动画背景系统。
...
- [style.css:191-203](file://css/style.css#L191-L203)
